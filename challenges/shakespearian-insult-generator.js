...
// YOUR CODE HERE
function shakeSpear() {
var first=first_word[Math.round(first_word.length*Math.random())];
var second=second_word[Math.round(second_word.length*Math.random())];
var third=third_word[Math.round(third_word.length*Math.random())];
console.log("You "+first+", "+second+", "+third+", you!")
}
