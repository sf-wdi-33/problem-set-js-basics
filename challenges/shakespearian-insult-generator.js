...
//Why are some of the values in the arrays different colors?

function generateInsult(n) {
  var name = prompt("What is thy name?");
  var harshness = prompt("wherefore holla th're " + name + ". On a scale of one to three, how harsh wouldst thee liketh this fig to beest?")
